...
FRED_INDICATORS = [
    ...
    {"series_id": "PNICKUSDM", "id": "nickel", "name": "Nickel", "unit": "USD/ton", "category": "raw_materials",
     "high_threshold": 22000, "medium_threshold": 16000, "inverted": False},
...
STATIC_INDICATORS = [
    ...
    {"id": "molybdenum", "name": "Molybdenum", "unit": "USD/kg", "category": "raw_materials",
     "value": 68.5, "change": 3.8, "date": "Mar 14", "risk_level": "MEDIUM"},
    {"id": "chromium", "name": "Chromium", "unit": "USD/ton", "category": "raw_materials",
     "value": 9200, "change": 1.5, "date": "Mar 14", "risk_level": "MEDIUM"},
    {"id": "zinc", "name": "Zinc", "unit": "USD/ton", "category": "raw_materials",
     "value": 2850, "change": -1.8, "date": "Mar 14", "risk_level": "LOW"},
...
# ──────────────────────────────────────────────
DOMAINS = {
    "Geopolitical": {"weight": 0.25, "indicator_ids": [], "zone_category": "geopolitical"},
    "Maritime":     {"weight": 0.25, "indicator_ids": ["bdi", "scfi"], "zone_category": "maritime"},
    "Energy":       {"weight": 0.15, "indicator_ids": ["brent", "wti", "natgas", "gasoline"], "zone_category": None},
    "Raw Materials": {"weight": 0.15, "indicator_ids": ["copper", "aluminum", "ironore", "steel", "nickel", "molybdenum", "chromium", "zinc"], "zone_category": None},
    "Weather":      {"weight": 0.10, "indicator_ids": [], "zone_category": "disaster"},
    "Trade Policy": {"weight": 0.05, "indicator_ids": [], "zone_category": None},
